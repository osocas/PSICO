...
class Perfil : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Si se pulsa en la imagen de perfil se accede al fileUpload() para abrir la galería del movil y añadir una foto
    ...
    private fun setup(){
        ...
        bt_cerrar_sesion.setOnClickListener{
            FirebaseAuth.getInstance().signOut() //se cierra la sesión del usuario
            val Intent = Intent(this, MainActivity::class.java)
    ...
    private fun intentPublicitarse(){
        //Si el usuario pulsa el botón de publicitarse como psicólogo va a esa pantalla
